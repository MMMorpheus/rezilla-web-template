...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   c: function() { return /* binding */ classesToSelector; }\n/* harmony export */ });\nfunction classesToSelector(classes) {\n  if (classes === void 0) {\n    classes = '';\n  }\n  return `.${classes.trim().replace(/([\\.:!+\\/])/g, '\\\\$1') // eslint-disable-line\n  .replace(/ /g, '.')}`;\n}\n\n\n\n\n//# sourceURL=webpack://gulp-frontend-vanilla/./node_modules/swiper/shared/classes-to-selector.mjs?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   Swiper: function() { return /* reexport safe */ _shared_swiper_core_mjs__WEBPACK_IMPORTED_MODULE_0__.S; },\n/* harmony export */   \"default\": function() { return /* reexport safe */ _shared_swiper_core_mjs__WEBPACK_IMPORTED_MODULE_0__.S; }\n/* harmony export */ });\n/* harmony import */ var _shared_swiper_core_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./shared/swiper-core.mjs */ \"./node_modules/swiper/shared/swiper-core.mjs\");\n/**\n * Swiper 10.0.4\n * Most modern mobile touch slider and framework with hardware accelerated transitions\n * https://swiperjs.com\n *\n * Copyright 2014-2023 Vladimir Kharlampidi\n *\n * Released under the MIT License\n *\n * Released on: July 8, 2023\n */\n\n\n\n\n//# sourceURL=webpack://gulp-frontend-vanilla/./node_modules/swiper/swiper.mjs?");

/***/ }),

/***/ "./src/scripts/DOM/burger.js":
/*!***********************************!*\
  !*** ./src/scripts/DOM/burger.js ***!
  \***********************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _utils_scroll_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/scroll.js */ \"./src/scripts/utils/scroll.js\");\n/* harmony import */ var _utils_aria_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/aria.js */ \"./src/scripts/utils/aria.js\");\n/* harmony import */ var _utils_navigationScroll_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/navigationScroll.js */ \"./src/scripts/utils/navigationScroll.js\");\n/* harmony import */ var _app_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../app.js */ \"./src/scripts/app.js\");\n\n\n\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (() => {\n  const { burgerEl, menuEl } = _app_js__WEBPACK_IMPORTED_MODULE_3__.elements;\n\n  const isMobile = window.matchMedia('(max-width: 991.98px)');\n  let isMenuOpened = false;\n\n  // Handling menu's state by changing classNames\n  burgerEl?.addEventListener('click', () => {\n    if (isMobile.matches) {\n      isMenuOpened ? (isMenuOpened = false) : (isMenuOpened = true);\n\n      burgerEl.classList.toggle('burger-active');\n      menuEl.style.top = `${document.querySelector('.header').getBoundingClientRect().bottom}px`;\n      menuEl.classList.toggle('menu-active');\n\n      // If is opened, handling scroll and aria attr's\n      if (isMenuOpened) {\n        _utils_aria_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].open(burgerEl, 'menu');\n        _utils_scroll_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].disable();\n      } else {\n        _utils_aria_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].close(burgerEl, 'menu');\n        _utils_scroll_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].enableWithOffset();\n      }\n    }\n  });\n\n  // Handling scroll behaviour and aria attr's by click on menu elements\n  menuEl.addEventListener('click', (e) => {\n    if (isMobile.matches) {\n      burgerEl.classList.toggle('burger-active');\n      menuEl.classList.toggle('menu-active');\n    }\n    if (isMenuOpened) {\n      _utils_aria_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].close(burgerEl, 'menu');\n      _utils_scroll_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].enableWithOffset();\n      isMenuOpened = false;\n    }\n    if (e.target.tagName === 'A') {\n      (0,_utils_navigationScroll_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(e);\n    }\n  });\n});\n\n\n//# sourceURL=webpack://gulp-frontend-vanilla/./src/scripts/DOM/burger.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   elements: function() { return /* binding */ elements; }\n/* harmony export */ });\n/* harmony import */ var _utils_DOMLoaded_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./utils/DOMLoaded.js */ \"./src/scripts/utils/DOMLoaded.js\");\n/* harmony import */ var _utils_throttle_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/throttle.js */ \"./src/scripts/utils/throttle.js\");\n/* harmony import */ var _utils_navigationScroll_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/navigationScroll.js */ \"./src/scripts/utils/navigationScroll.js\");\n/* harmony import */ var _DOM_menuObserver_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./DOM/menuObserver.js */ \"./src/scripts/DOM/menuObserver.js\");\n/* harmony import */ var _DOM_burger_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./DOM/burger.js */ \"./src/scripts/DOM/burger.js\");\n/* harmony import */ var _DOM_form_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./DOM/form.js */ \"./src/scripts/DOM/form.js\");\n/* harmony import */ var _DOM_marquee_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./DOM/marquee.js */ \"./src/scripts/DOM/marquee.js\");\n/* harmony import */ var _DOM_sliders_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./DOM/sliders.js */ \"./src/scripts/DOM/sliders.js\");\n/* harmony import */ var _DOM_listings_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./DOM/listings.js */ \"./src/scripts/DOM/listings.js\");\n// Utils\n\n\n\n\n\n// DOM elements\nconst burgerEl = document.querySelector('[data-burger]');\nconst menuEl = document.querySelector('[data-menu');\nconst menuItemsEl = document.querySelectorAll('[data-menu-item]');\nconst formEl = document.querySelector('[data-form]');\nconst circleTextEl = document.querySelector('[data-circle]');\nconst filtersEl = document.querySelectorAll('[data-filter]');\nconst listingsEl = document.querySelectorAll('[data-listing]')\nconst homeSliderEl = document.querySelector('[data-slider=\"home\"]');\nconst testimonialsSliderEl = document.querySelector('[data-slider=\"testimonials\"]');\nconst blogSection = document.querySelector('.blog');\nconst blogArticlesWrapper = document.querySelector('.articles__wrapper');\nconst blogArticlesBtnEl = document.querySelector('.blog__showMoreBtn');\nconst footerLinksEl = document.querySelector('.footer__links ul')\n\nconst elements = {\n  burgerEl,\n  menuEl,\n  menuItemsEl,\n  formEl,\n  circleTextEl,\n  filtersEl,\n  listingsEl,\n  homeSliderEl,\n  blogSection,\n  blogArticlesWrapper,\n  blogArticlesBtnEl,\n};\n\n// DOM manipulation\n\n\n\n\n\n\n(0,_utils_DOMLoaded_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(() => {\n  // Тут исполняем скрипты\n  const { initHomeSlider, initTestimonialsSlider, handleLayout, displayArticles } = (0,_DOM_sliders_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"])();\n\n  (0,_DOM_burger_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"])();\n  (0,_DOM_form_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"])();\n  (0,_DOM_marquee_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"])();\n  (0,_DOM_listings_js__WEBPACK_IMPORTED_MODULE_8__[\"default\"])();\n  displayArticles();\n\n  // Слайдеры\n  initHomeSlider(homeSliderEl);\n  initTestimonialsSlider(testimonialsSliderEl);\n  handleLayout();\n\n  // Тротлим инициализацию слайдера, если окно ресайзится, чтобы отключать слайдер на мобилках\n  window.addEventListener('resize', (0,_utils_throttle_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(handleLayout, 500));\n\n  // Other\n  footerLinksEl.addEventListener('click', (e) => {\n    (0,_utils_navigationScroll_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(e)\n  })\n\n  ;(0,_DOM_menuObserver_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"])()\n});\n\n\n//# sourceURL=webpack://gulp-frontend-vanilla/./src/scripts/app.js?");

/***/ }),

/***/ "./src/scripts/utils/DOMLoaded.js":
/*!****************************************!*\
  !*** ./src/scripts/utils/DOMLoaded.js ***!
  \****************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = ((fn) => {\n  // Если DOM только загружается, то ф-я сработает после загрузки\n  if (document.readyState === 'loading') {\n    document.addEventListener('DOMContentLoaded', fn);\n  } else {\n    // Иначе она вызовется немедленно\n    fn();\n  }\n});\n\n\n//# sourceURL=webpack://gulp-frontend-vanilla/./src/scripts/utils/DOMLoaded.js?");

/***/ }),

/***/ "./src/scripts/utils/aria.js":
/*!***********************************!*\
  !*** ./src/scripts/utils/aria.js ***!
  \***********************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n// Apply as you need for some expandable elements\nconst openAria = (element, label) => {\n  element?.setAttribute('aria-expanded', 'true');\n  element?.setAttribute('aria-label', `Close ${label}`);\n};\n\nconst closeAria = (element, label) => {\n  element?.setAttribute('aria-expanded', 'false');\n  element?.setAttribute('aria-label', `Open ${label}`);\n};\n\n\nconst aria = {\n  open: openAria,\n  close: closeAria,\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (aria);\n\n\n//# sourceURL=webpack://gulp-frontend-vanilla/./src/scripts/utils/aria.js?");

/***/ }),

/***/ "./src/scripts/utils/navigationScroll.js":
/*!***********************************************!*\
  !*** ./src/scripts/utils/navigationScroll.js ***!
  \***********************************************/
/***/ (function(__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": function() { return /* export default binding */ __WEBPACK_DEFAULT_EXPORT__; }\n/* harmony export */ });\n// To provide navigation, you should specify link's data-target=\"target-section-selector\"\n// Example: <a data-targer=\".home\"> => <section class=\"home\">\n\n/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(click) {\n  try {\n    const targetEl = document.querySelector(click.target.dataset.target);\n    const headerHeight = document.querySelector('.header').offsetHeight;\n    const currentScroll = window.scrollY;\n\n    const scrollDistance = targetEl.getBoundingClientRect().top + currentScroll - headerHeight;\n\n    window.scrollTo({\n      top: scrollDistance,\n      behavior: 'smooth',\n    });\n\n    click.preventDefault();\n  } catch (error) {\n    console.log(error);\n  }\n}\n\n\n//# sourceURL=webpack://gulp-frontend-vanilla/./src/scripts/utils/navigationScroll.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\nfunction throttle(cb, delay) {\n  let isThrottled = false;\n  let waitingArgs;\n\n  const timeoutFunc = () => {\n    if(waitingArgs == null) {\n      isThrottled = false;\n    } else {\n      cb(...waitingArgs);\n      waitingArgs = null;\n      setTimeout(timeoutFunc, delay)\n    }\n  }\n\n  return (...args) => {\n    if(isThrottled) {\n      waitingArgs = args;\n      return;\n    }\n\n    cb(...args);\n    isThrottled = true;\n\n    setTimeout(timeoutFunc, delay)\n  }\n}\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (throttle);\n\n\n//# sourceURL=webpack://gulp-frontend-vanilla/./src/scripts/utils/throttle.js?");
